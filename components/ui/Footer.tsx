          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                aria-label="GitHub"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-border text-muted transition-colors hover:border-primary hover:text-text"
              >
                <svg
                  width="16"
                  height="16"
