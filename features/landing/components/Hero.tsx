    ...
    return (
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto text-center">
                <h1 className="text-4xl font-bold">Manage team tasks and stand-ups effortlessly</h1>
                <p className="w-90 text-center mx-auto mt-2 text-white/65">Project Standup helps you and your team to make project development more transparent.</p>
                <div className="flex flex-row items-center justify-center gap-4 mt-8">
                    <Link
                        href="/signup"
                        className="relative inline-block p-0.5 text-[1rem] rounded-2xl border-none bg-[radial-gradient(circle_80px_at_80%_-10%,#ffffff,#181b1b)] cursor-pointer after:content-[''] after:absolute after:w-[65%] after:h-[60%] after:rounded-[120px] after:top-0 after:right-0 after:shadow-[0_0_20px_#ffffff38] after:z-[-1]"
                ...
                <div className="relative mt-8 w-[80%] rounded-2xl overflow-hidden aspect-video m-auto">
                    {/* <Image
                        src={s}
